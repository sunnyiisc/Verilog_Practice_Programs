...
HD_PWD='C:/Users/spnth/Downloads/Working_Directory/temp/Verilog_Practice_Programs/Verilog_Practice_Programs.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log counter_3bit_up.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source counter_3bit_up.tcl
