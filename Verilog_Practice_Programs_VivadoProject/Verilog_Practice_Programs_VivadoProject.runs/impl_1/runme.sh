...
HD_PWD='C:/Users/spnth/Downloads/Working_Directory/temp/Verilog_Practice_Programs/Verilog_Practice_Programs.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log counter_3bit_up.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source counter_3bit_up.tcl -notrace
